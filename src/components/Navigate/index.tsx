  ...
  return (
    ...
    <div className="bg-navigateBg">
      ...
      {openMenu && (
        ...
        <div className="max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:flex max-lg:flex-col max-lg:items-start max-lg:w-72 max-lg:h-screen max-lg:bg-white max-lg:pt-3  max-xs:w-full">
